...
class  Choices extends Component {
        ...
        render (){
          ...
          return(
            <div id="box">
                    {values.map(item => <button  className="choice btn btn- my-3 border border-info "   onClick={()=> {
                      if (res[1] == "dashboardcollab")
                      {
